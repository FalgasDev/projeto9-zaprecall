...
export default function Footer({counter, footerIcon}) {
  return (
    <ContainerFooter counter={counter} footerIcon={footerIcon} data-test="footer">
      <EndMessage data-test="finish-text" counter={counter}>
        ...
        <h2>{footerIcon.includes(wrong) ? 'Ainda faltam alguns... Mas não desanime!' : 'Você não esqueceu de nenhum flashcard!'}</h2>
      </EndMessage>
